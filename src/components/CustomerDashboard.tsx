...
<AuditChecklist currentAccount={currentAccount} onUpdateAccount={onUpdateAccount} DOCUMENT_TYPES={DOCUMENT_TYPES} initializeChecklist={initializeChecklist} computeAccountStage={computeAccountStage} />
          </div>
